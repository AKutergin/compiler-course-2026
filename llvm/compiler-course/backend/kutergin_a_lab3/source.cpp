    ...
    for (auto &MBB : MF) {
      for (auto I = MBB.begin(); I != MBB.end(); ) {
        ...
        if (Opcode == X86::INC32r || Opcode == X86::INC64r ||
          ...
          int Accumulator = (Opcode == X86::INC32r || Opcode == X86::INC64r) ? 1 : -1;
          ...
          while (NextI != MBB.end()) {
            ...
            if ((NextOp == X86::INC32r || NextOp == X86::INC64r ||
              ...
              Accumulator += (NextOp == X86::INC32r || NextOp == X86::INC64r) ? 1 : -1;
...
static RegisterPass<IncDecToAddSubPass> X("inc-dec-to-add-sub", "X86 INC/DEC to ADD/SUB transformation", false, false);